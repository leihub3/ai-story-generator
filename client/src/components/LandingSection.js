...
const LandingSection = ({ onScrollToGenerate }) => {
  ...
  return (
    <LandingContainer onMouseMove={createSparkle}>
      ...
      <Content>
        ...
        >
          Create magical stories with AI-generated text and illustrations. Generate, read, and share
          <br />
        ...
        >
          ...
          >
            ...
            <FeatureTitle as="h3">AI Story Generation with Illustrations</FeatureTitle>
            <FeatureDescription>
              Simply describe your idea, and our AI creates engaging, 
              child-friendly stories with beautiful, AI-generated illustrations that perfectly match the narrative. 
              Each tale is tailored to your preferences and visually engaging. 
          ...
          >
            <FeatureIcon aria-hidden="true">🌍📚</FeatureIcon>
            <FeatureTitle as="h3">Multi-Language Support</FeatureTitle>
            <FeatureDescription>
          ...
          >
            ...
            <FeatureTitle as="h3">Interactive Reading</FeatureTitle>
            <FeatureDescription>
              Read stories aloud with text-to-speech, save your favorites, 
              and enjoy a beautiful reading experience designed for all ages.
            </FeatureDescription>
          </FeatureCard>
        </FeaturesGrid>
